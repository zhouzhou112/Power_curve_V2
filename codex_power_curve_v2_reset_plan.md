...
`ProcessPoolExecutor` 并行抽取。默认配置为 `weather_parallel_workers: 4`，
...
```powershell
& "C:\Users\ZZ\.conda\envs\RL\python.exe" -X utf8 scripts\02_reconstruct_weather_and_thermal_load.py --run-dir outputs\run_<module01_run> --weather-workers 4
```
